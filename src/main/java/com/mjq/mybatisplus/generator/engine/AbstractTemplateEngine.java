 ...
 * the License.
 */
package com.mjq.mybatisplus.generator.engine;

import com.mjq.mybatisplus.generator.InjectionConfig;
import com.mjq.mybatisplus.generator.config.ConstVal;
import com.mjq.mybatisplus.generator.config.FileOutConfig;
import com.mjq.mybatisplus.generator.config.GlobalConfig;
import com.mjq.mybatisplus.generator.config.TemplateConfig;
import com.mjq.mybatisplus.generator.config.builder.ConfigBuilder;
import com.mjq.mybatisplus.generator.config.po.TableInfo;
import com.mjq.mybatisplus.generator.config.rules.FileType;
import com.mjq.mybatisplus.generator.util.CollectionUtils;
import com.mjq.mybatisplus.generator.util.PackageHelper;
        ...
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                if (null != tableInfo.getProviderName() && null != pathInfo.get(ConstVal.PROVIDER_PATH)) {
                    String providerFile = String.format((pathInfo.get(ConstVal.PROVIDER_PATH) + File.separator + tableInfo.getProviderName() + suffixJavaOrKt()), entityName);
                    if (isCreate(FileType.PROVIDER, providerFile)) {
                        writer(objectMap, templateFilePath(template.getProvider()), providerFile);
                    }
                }
//                // MpMapper.xml
